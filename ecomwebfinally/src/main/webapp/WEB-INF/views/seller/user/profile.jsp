		...
		<div class="col-xl-4">
			...
			<div class="card">
				<div
					...
					<img src="${seller.avatar}" alt="Profile" class="rounded-circle">
					...
					<div class="tab-content pt-2">
						...
						<div class="tab-pane fade show active profile-overview"
							...
							<p class="small fst-italic">Sunt est soluta temporibus
								...
								quisquam autem eveniet perspiciatis odit. Fuga sequi sed ea
								saepe at unde.</p>
							...
							<div class="row">
								...
								<div class="col-lg-9 col-md-8">${seller.firstName}
									${seller.lastName}</div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Số Điện Thoại</div>
								<div class="col-lg-9 col-md-8">${seller.phone}</div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Vai Trò</div>
								<div class="col-lg-9 col-md-8">Người Bán Hàng</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-lg-9 col-md-8">${seller.address }</div>
							</div>

							<div class="row">
								<div class="col-lg-3 col-md-4 label">Tài Khoản</div>
								<div class="col-lg-9 col-md-8">${seller.username}</div>
							</div>
