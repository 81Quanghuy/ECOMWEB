...
<section class="bg-img1 txt-center p-lr-15 p-tb-92"
	style="background-image: url('${URL}images/bg-01.jpg');">
				...
				<form>
					...
					<div class="bor8 m-b-20 how-pos4-parent">
						...
						<img class="how-pos4 pointer-none"
							src="${URL}images/icons/icon-email.png" alt="ICON">
					</div>
			...
			<div
				...
				<div class="flex-w w-full p-b-42">
					...
					<div class="size-212 p-t-2">
						...
						<p class="stext-115 cl6 size-213 p-t-18">Coza Store Center 8th
							floor, 379 Hudson St, New York, NY 10018 US</p>
					</div>
				</div>
...
<!-- Map -->
<div class="map">
	<div class="size-303" id="google_map" data-map-x="10.833991"
		data-map-y="106.791052" data-pin="${URL}images/icons/pin.png"
