...
@Controller
@RequestMapping("seller/deliveries")
public class SellerDeliveryController {
	...
	public String add(ModelMap model) {
		...
		return "seller/deliveries/addOrEdit";
	...
	{
		if (result.hasErrors()) {
			return new ModelAndView("seller/deliveries/addOrEdit");
		}
		...
		return new ModelAndView("forward:/seller/deliveries", model);
	...
	public ModelAndView edit(ModelMap model, @PathVariable("id") Integer id) throws IOException {
		...
		if (opt.isPresent()) {
			...
			return new ModelAndView("seller/deliveries/addOrEdit", model);
		}
	...
	public ModelAndView delete(ModelMap model, @PathVariable("id") Integer id) {
		...
		return new ModelAndView("redirect:/seller/deliveries", model);
