...
public class CartItemController {
	...
	public ModelAndView saveOrUpdate(ModelMap model, @Valid @ModelAttribute("CartItem") CartItemModel CartItem,
		...
		Cart cart = cartService.getById(CartItem.getCartid());

		BeanUtils.copyProperties(CartItem, entity);
		entity.setProduct(product);
		entity.setCart(cart);
		long millis = System.currentTimeMillis();
		Date date = new Date(millis);
		if (CartItem.getIsEdit()) {
